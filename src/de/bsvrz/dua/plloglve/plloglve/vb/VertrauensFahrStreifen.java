...
/**
 * Repräsentiert einen Fahrstreifen mit allen Informationen, die zur
 * Ermittlung des Vertrauens in diesen Fahrstreifen notwendig sind 
 * 
			...
			synchronized (this) {
				if(this.parameter != null && this.parameter.isAuswertbar()){
					...
					if(verletztAktuell){
						 ...
						 * Betriebsmeldung muss nicht ausgegeben werden, da dies ggf. schon für jeden
