...
public final class AusfallDatum implements IIntervallDatum<AusfallDatum> {
	 ...
	 *         Klasse oder <code>null</code> fuer <code>keine Quelle</code> usw.
	 */
	public static AusfallDatum getAusfallDatumVon(final ResultData resultat) {
	 ...
	 */
	@Override
	public boolean istGleich(final AusfallDatum that) {
